...
const fields =
  "id, media_type, children{media_url}, media_url, caption, timestamp, username, permalink";
const accessToken =
  "IGQWRQbm9VWk12UjlaZATVSV0JoM0hPMGlGSHdSQkR3UVQ1TVdLb1N4Tk51N1NDLXVVZAnRJRmNPczNNbVdpeHBjblV6SkRCLUNPNFY1dDl5UkRHaDR2c3dYckdUZADVXWFB4OUx3dGJ0WUJidkVOX2d3TlBIMDhRcUUZD";
const desiredImages = 4;
let fetchedImages = 0;

// higher limit to prevent reels or videos
fetch(
  `https://graph.instagram.com/me/media?fields=${fields}&limit=10&access_token=${accessToken}`
)
...
function openPopup(media) {
  ...
  postInfo.innerHTML = `
        ...
        <div id="bottom">
            <div class="row">
                <p id="timestamp" class="light">${formatDate(
